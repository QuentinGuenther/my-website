...
export type BioQueryQuery = { avatar?: Maybe<Pick<File, 'relativePath'>>, site?: Maybe<{ siteMetadata?: Maybe<{ author?: Maybe<Pick<Author, 'name' | 'summary'>>, social?: Maybe<Pick<Social, 'twitter'>> }> }> };
